...
export const ROOM_ERRORS = {
    "TO_LOGIN" : "Log in or Sign up to account to join room",
    "ROOM_DOES_NOT_EXIST": "Room doesn't exist",
    "INCORRECT_PASSWORD": "Password is incorrect",
    "YOU_ALREADY_HAVE_ROOM": "You already have created room",
    "ROOM_NAME_ALREADY_EXISTS": "Room with this name already exist",
}
